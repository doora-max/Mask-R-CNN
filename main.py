...
parser.add_argument("--detection-threshold","-d",default = 0.7,type = float,help = "confidence threshold for detection (0-1)")
parser.add_argument("--mask-threshold",default = 0.7,type = float,help = "confidence threshold for segmantation mask (0-1)")
